...
* NOTE: Avoid declaring with "var", which you will see in older JS documentation.
* Declarations [let](https://p5js.org/reference/p5/let/) and [const](https://p5js.org/reference/p5/const/).     
