...
Save the completed sketch as "SS3_[FirstName + Last Initial]" (for example, "SS3_IanP"). Submit to your GitHub repo **before the beginning of the next class session**.    
